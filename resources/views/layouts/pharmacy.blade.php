...
<head>
    ...
    <title>@yield('title', 'Pharmacy Panel') - Prescription System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top no-print">
        <div class="container">
            <a class="navbar-brand fw-bold text-pharmacy" href="{{ route('pharmacy.dashboard') }}">
            ...
            <div class="collapse navbar-collapse" id="pharmacyNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pharmacy.dashboard') ? 'active' : '' }}" href="{{ route('pharmacy.dashboard') }}">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-person-circle me-1"></i> {{ Auth::guard('pharmacy')->user()->name }}
                        </a>
