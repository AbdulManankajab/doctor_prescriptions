...
@section('title', 'Radiology History - ' . $patient->name)
    ...
    <div class="col-12">
        <div class="mb-4 d-flex justify-content-between align-items-center">
            <div>
                ...
                <h3 class="fw-bold mt-2">Radiology History</h3>
                <p class="text-muted">Patient: {{ $patient->name }} | {{ $patient->gender }}, {{ $patient->age }} years</p>
            </div>
            <a href="{{ route('doctor.radiology.create', $patient->id) }}" class="btn btn-primary rounded-pill px-4">
        ...
        @forelse($requests as $request)
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white p-4 border-0 d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="fw-bold mb-0">{{ $request->test_name }}</h5>
                ...
                <div class="card-body p-4 pt-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border-start">
                            <h6 class="fw-bold small text-uppercase text-muted mb-2">Radiology Report</h6>
                            ...
                            @else
                                <div class="text-muted italic p-3 border rounded-3 bg-light">
                                    <i class="bi bi-hourglass-split me-2"></i> Report is pending...
                                </div>
                            @endif
                        </div>
                    </div>
        ...
        @empty
            <div class="card border-0 shadow-sm p-5 text-center">
                ...
                <h4 class="text-muted">No radiology history found.</h4>
